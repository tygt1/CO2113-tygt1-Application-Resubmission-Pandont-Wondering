...
public class CharacterSelectionManager : MonoBehaviour
{
    ...
    public void ReadyPlayer(int playerIndex)
    {
        ...
        {
            SceneManager.LoadScene("LocalMultiplayerStageSelect");
        }
    }

    public void HandlePlayerJoin(PlayerInput playerInput)
    {
        Debug.Log("Player Joined" + playerInput.playerIndex + "Player control scheme" + playerInput.currentControlScheme);
